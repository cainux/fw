...
{
    public class When_searching_by_partial_Title : Given_a_MovieService
    {
        private readonly IList<Movie> actual;

        public When_searching_by_partial_Title()
        {
            // Arrange
            ...
            // Act
            actual = SUT.SearchMoviesAsync("ooMov", null, null).Result;
        }
